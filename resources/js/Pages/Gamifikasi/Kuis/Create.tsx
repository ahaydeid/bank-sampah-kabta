...
export default function Create() {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('gamifikasi.kuis.store'));
    };

    return (
        <AuthenticatedLayout>
            <Head title="Tambah Soal Kuis" />
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-800 tracking-tight">Tambah Soal Baru</h1>
                    </div>
                </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Berikan penjelasan singkat mengapa jawaban tersebut benar untuk mengedukasi pengguna."
                                    />
